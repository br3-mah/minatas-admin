<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="bg-transparent page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Related Party</h4>

                    <div class="page-title-right">
                        <ol class="m-0 breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Related Party</li>
                        </ol>
                    </div>
        ...
        <div class="alert alert-info" role="alert">
            List of all borrower's related-party respective
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="guarantorTable" class="table align-middle table-bordered dt-responsive nowrap table-striped" style="width:100%">
                            ...
                            <tbody>
                                @forelse($related_parties as $user)
                                    <tr>
