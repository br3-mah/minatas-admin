<div class="page-content">
    <a href="{{ route('item-settings', ['confg' => 'loan','settings' => 'loan-disbursements']) }}" class="flex py-4 px-9">
        <span>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <!--begin::Container-->
        <form wire:submit.prevent="update_disbursement" id="kt_content_container" class="container-xxl">
