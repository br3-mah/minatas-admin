                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form wire:submit.prevent="createLoanCategory" class="row g-3">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select required wire:model.lazy="loan_type_id" id="loanPackage" class="form-select" required>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea cols="5"rows="10" wire:model.lazy="loan_category_desc" class="form-control" id="fullnameInput" placeholder="Loan category desc"></textarea>
