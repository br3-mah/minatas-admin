        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                    <h4 class="mb-sm-0">Add Loan Parent Type Information</h4>
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Add Loan Parent Types</li>
                        </ol>
                    </div>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Loan Parent Type Information</h4>
                    </div>

                    <div class="card-body">
                        <div class="live-preview">
                            <form wire:submit.prevent="update_loan_type" class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" wire:model.lazy="loan_type_name" class="form-control" id="fullnameInput" placeholder="Enter loan type name">
